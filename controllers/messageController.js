...
exports.replyToMessage = async (req, res, next) => {
  try {
    ...
    const replyMessage = await messageService.createReply(originalMessageId, userId, replyContent);
...
exports.reactToMessage = async (req, res, next) => {
  try {
    ...
    const reactionResult = await messageService.addReaction(messageId, userId, reaction);
...
exports.forwardMessage = async (req, res, next) => {
  try {
    ...
    const forwarded = await messageService.forwardMessage(messageId, userId, targetChatId);
